  ...
  namespace CamBamExtensions {
    public static class Geom {
      ...
      public static int CompareXY(this Triangle3F a, Triangle3F b) {
        ...
        } else if (b.ContainsXY(a.A) && b.ContainsXY(a.B)
                   && b.ContainsXY(a.C)) {
            rv = -1;
        }
        return rv;
      ...
      public static void Slice(this Triangle3F t, Line3F line,
        ...
        for (int i = 0; i < 3; ++i) {
          ...
          if (!intersection.IsUndefined
              && edge.PointWithinLine(intersection, TOL)) {
      ...
      private static void AddFacets(ref Triangle3FArray facets,
        ...
        if (facet1.CalcNormal().Z >= 0) {   // TODO: verify true for
                                            // CCW, use normal
          facets.Add(facet1);
